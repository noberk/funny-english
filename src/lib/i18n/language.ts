export const Lang: any = {
  en: {
    ...
    leftNav: {
      menu1: { name: "Student", subMenu: ["Student List", "Student Info"] },
      menu2: { name: "Write", subMenu: ["Vocabulary", "Article"] },
  ...
  cn: {
    ...
    leftNav: {
      menu1: { name: "学生", subMenu: ["学生列表", "学生信息"] },
      menu2: { name: "录入", subMenu: ["词汇", "文章"] },
  ...
  jp: {
    ...
    leftNav: {
      menu1: { name: "學生", subMenu: ["學生リスト", "學生情報"] },
      menu2: { name: "錄入", subMenu: ["詞彙", "文章"] },
